...
**Note:**
When _blkSc_ is communicating with the web assembly form of scsynth the mouse controls are implemented in terms of the _Pointer_ pseudo unit-generators.
